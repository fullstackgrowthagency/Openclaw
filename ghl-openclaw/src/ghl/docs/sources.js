...
export const VERIFIED_ENDPOINT_SEEDS = [
  ...
  ['facebook_ads', 'GET', '/ad-publishing/facebook/entity', 'location', 'admanager/entities.readonly'],
  ['facebook_ads', 'GET', '/ad-publishing/facebook/campaigns/:campaignId', 'location', 'admanager/campaigns.readonly'],
  ['facebook_ads', 'PUT', '/ad-publishing/facebook/campaigns', 'location', 'admanager/campaigns.write'],
  ['facebook_ads', 'PUT', '/ad-publishing/facebook/adsets', 'location', 'admanager/adsets.write'],
  ['facebook_ads', 'PUT', '/ad-publishing/facebook/ads', 'location', 'admanager/ads.write'],
  ['facebook_ads', 'POST', '/ad-publishing/facebook/campaigns/:campaignId/publish', 'location', 'admanager/campaigns.write'],
  ['voice_ai', 'GET', '/voice-ai/dashboard/call-logs', 'location', 'voice-ai-dashboard.readonly'],
  ['voice_ai', 'GET', '/voice-ai/dashboard/call-logs/:callId', 'location', 'voice-ai-dashboard.readonly'],
  ['voice_ai', 'GET', '/voice-ai/agents', 'location', 'voice-ai-agents.readonly'],
  ['voice_ai', 'GET', '/voice-ai/agents/:agentId', 'location', 'voice-ai-agents.readonly'],
  ['voice_ai', 'POST', '/voice-ai/agents', 'location', 'voice-ai-agents.write'],
  ['voice_ai', 'PATCH', '/voice-ai/agents/:agentId', 'location', 'voice-ai-agents.write'],
